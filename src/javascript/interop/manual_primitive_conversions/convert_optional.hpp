...
inline auto v8pp::convert<ext::optional<T>>::from_v8(v8::Isolate* isolate, v8::Local<v8::Value> v8_value) -> from_type
{
    ...
    return from_type{v8_value->IsNull() ? ext::nullopt : convert<T>::from_v8(isolate, v8_value)};
}


template <typename T>
inline auto v8pp::convert<ext::optional<T>>::to_v8(v8::Isolate* isolate, from_type cpp_value_optional) -> to_type
{
    ...
    auto v8_value = cpp_value_optional.has_value() ? convert<T>::to_v8(isolate, cpp_value_optional) : v8::Null(isolate);
