...
struct v8pp::convert<ext::number<T>>
{
    ...
    auto static is_valid(v8::Isolate* isolate, v8::Local<v8::Value> v8_value) -> ext::boolean {return not v8_value.IsEmpty() && v8_value->IsNumber();}
...
#endif //SBROWSER2_CONVERT_NUMBER_FLOAT_HPP
