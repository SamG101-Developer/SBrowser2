...
inline auto v8pp::convert<ext::boolean>::is_valid(
        v8::Isolate* isolate,
        v8::Local<v8::Value> v8_value)
        -> ext::boolean
{
...
inline auto v8pp::convert<ext::boolean>::from_v8(
        v8::Isolate* isolate,
        v8::Local<v8::Value> v8_value)
        -> from_type
{
    ...
    auto cpp_value_bool_object    = from_type{cpp_value_bool_primitive};
    return cpp_value_bool_object;
}


auto v8pp::convert<ext::boolean>::to_v8(
        v8::Isolate* isolate,
        const from_type& cpp_value_bool_object)
        -> to_type
{
