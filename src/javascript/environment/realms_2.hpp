...
// auto js::env::realms::has(global_object_t global, ext::string_view cpp_attribute) -> ext::boolean
// {
...
//
// template <typename T>
// auto js::env::realms::get(global_object_t global, ext::string_view cpp_attribute) -> T
// {
//     auto v8_private_attribute = v8::Private::New(global->GetIsolate(), v8pp::to_v8(global->GetIsolate(), cpp_attribute).As<v8::String>());
...
//
// template <typename T>
// auto js::env::realms::set(global_object_t global, ext::string_view cpp_attribute, T cpp_value) -> ext::boolean
// {
//     auto v8_private_attribute = v8::Private::New(global->GetIsolate(), v8pp::to_v8(global->GetIsolate(), cpp_attribute).As<v8::String>());
