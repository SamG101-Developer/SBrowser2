...
class html::canvasing::offscreen_canvas_rendering_context_2d
...
private cpp_properties:
    detail::bitmap_mode_t m_bitmap;
    ext::boolean m_alpha;
    detail::predefined_color_space_t m_color_space;
};


#endif //SBROWSER2_SRC_JAVASCRIPT_WEB_APIS_HTML_CANVASING_OFFSCREEN_CANVAS_RENDERING_CONTEXT_2D_HPP
