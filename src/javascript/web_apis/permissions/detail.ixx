...
{
    /* [5.1.1] */ auto get_current_permission_state(ext::string&& name, js::env::env& environment) -> permission_state_t;
    /* [5.1.2] */ auto permission_state(permission_descriptor_t&& permission_descriptor, js::env::env& environment) -> permission_state_t;
