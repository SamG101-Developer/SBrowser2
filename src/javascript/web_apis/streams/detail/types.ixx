...
{
    class abstract_readable_stream_controller;
    class abstract_readable_stream_reader;
...
DEFINE_FWD_DECL_NAMESPACE_DETAIL(streams)
{
    ...
    using underlying_source_start_callback_t = ext::function<ext::any(abstract_readable_stream_controller* controller)>;
    using underlying_source_pull_callback_t = ext::function<ext::promise<void>(abstract_readable_stream_controller* controller)>;
    ...
    using underlying_sink_write_callback_t = ext::function<ext::promise<void>(ext::any chunk, writable_stream_default_controller* controller)>;
    ...
    using transform_transformer_callback_t = ext::function<ext::promise<void>(ext::any chunk, transform_stream_default_controller* controller)>;
