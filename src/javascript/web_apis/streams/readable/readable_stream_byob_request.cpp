        ...
        -> void
{
    ...
    detail::abstract_operations_internals::readable_byte_stream_controller_response(s_controller, bytes_written);
}
        ...
        -> void
{
    ...
    return detail::abstract_operations_internals::readable_byte_stream_controller_response_with_new_view(s_controller, view);
}
