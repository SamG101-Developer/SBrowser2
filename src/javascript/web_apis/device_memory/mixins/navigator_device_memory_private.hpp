...
DEFINE_PRIVATE_CLASS(device_memory::mixins, navigator_device_memory) : virtual dom_object_private
{
    _EXT_NODISCARD auto device_memory() const -> ext::number<double> // TODO : other platforms
    {
        #ifdef _WIN32
