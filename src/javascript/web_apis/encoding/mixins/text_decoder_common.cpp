...
auto encoding::text_decoder_common::get_encoding() const -> ext::string
{
    ACCESS_PIMPL;
...
auto encoding::text_decoder_common::get_fatal() const -> ext::boolean
{
    ACCESS_PIMPL;
...
auto encoding::text_decoder_common::get_ignore_bom() const -> ext::boolean
{
    ACCESS_PIMPL;
    return d->ignore_bom;
}
