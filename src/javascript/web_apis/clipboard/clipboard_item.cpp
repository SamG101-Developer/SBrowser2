        ...
        ext::map<ext::string, ext::any>&& options)
{
    ...
    for (const auto& [key, value]: items)
    {
        ...
        m_types_array.emplace_back(mimesniff::detail::serialize_mime_type(*mime_type));
    }
}
        ...
        -> ext::promise<file_api::blob*>
{
    ...
    // Create the 'item_type_list' (which is the list of representations -- structs containing a mime type and data),
    // and the 'promise' object.
...
{
    // Get the presentation style of the current clipboard item
...
auto clipboard::clipboard_item::to_v8(
        ...
        const && -> ext::any
{
    return v8pp::class_<clipboard_item>{isolate}
        .inherit<dom_object>()
