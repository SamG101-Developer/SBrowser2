...
auto infra::detail::is_surrogate(typename T::value_type code_point) -> ext::boolean
{
...
template <ext::string_like T>
auto infra::detail::is_scalar(typename T::value_type code_point) -> ext::boolean
{
...
template <ext::string_like T>
auto infra::detail::is_non_character(typename T::value_type code_point) -> ext::boolean // TODO : format this method
{
    ...
    return ranges::contains(ranges::views::closed_iota(0xfdd0, 0xfdef), code_point) || ranges::contains(std::initializer_list<typename T::value_type>{
...
template <ext::string_like T>
auto infra::detail::is_ascii_code_point(typename T::value_type code_point) -> ext::boolean
{
...
template <ext::string_like T>
auto infra::detail::is_ascii_tab_or_newline(typename T::value_type code_point) -> ext::boolean
{
...
template <ext::string_like T>
auto infra::detail::is_ascii_newline(typename T::value_type code_point) -> ext::boolean
{
    ...
    return ranges::contains(std::initializer_list<typename T::value_type>{0x000A, 0x000D}, code_point);
}


template <ext::string_like T>
auto infra::detail::is_ascii_whitespace(typename T::value_type code_point) -> ext::boolean
{
    ...
    return ranges::contains(std::initializer_list<typename T::value_type>{0x0009, 0x000a, 0x000c, 0x000d, 0x0020}, code_point);
}


template <ext::string_like T>
auto infra::detail::is_c0_control(typename T::value_type code_point) -> ext::boolean
{
...
template <ext::string_like T>
auto infra::detail::is_c0_control_or_space(typename T::value_type code_point) -> ext::boolean
{
...
template <ext::string_like T>
auto infra::detail::is_control(typename T::value_type code_point) -> ext::boolean
{
...
template <ext::string_like T>
auto infra::detail::is_ascii_digit(typename T::value_type code_point) -> ext::boolean
{
...
template <ext::string_like T>
auto infra::detail::is_ascii_upper_hex_digit(typename T::value_type code_point) -> ext::boolean
{
...
template <ext::string_like T>
auto infra::detail::is_ascii_lower_hex_digit(typename T::value_type code_point) -> ext::boolean
{
...
template <ext::string_like T>
auto infra::detail::is_ascii_hex_digit(typename T::value_type code_point) -> ext::boolean
{
...
template <ext::string_like T>
auto infra::detail::is_ascii_upper_alpha(typename T::value_type code_point) -> ext::boolean
{
...
template <ext::string_like T>
auto infra::detail::is_ascii_lower_alpha(typename T::value_type code_point) -> ext::boolean
{
    return ranges::contains(ranges::views::closed_iota(0x0061, 0x007a), code_point);
}
...
template <ext::string_like T>
auto infra::detail::is_ascii_alpha(typename T::value_type code_point) -> ext::boolean
{
    return ranges::contains(ranges::views::closed_iota(0x0041, 0x005a), code_point);
}
...
template <ext::string_like T>
auto infra::detail::is_ascii_alphanumeric(typename T::value_type code_point) -> ext::boolean
{
