        ...
        -> ext::boolean
{
    ...
    return ranges::contains(ranges::views::closed_iota(0xfdd0, 0xfdef), code_point) || ranges::contains(std::initializer_list<char32_t>{
        ...
        -> ext::boolean
{
    ...
    return ranges::contains(std::initializer_list<char32_t>{0x000A, 0x000D}, code_point);
}
        ...
        -> ext::boolean
{
    ...
    return ranges::contains(std::initializer_list<char32_t>{0x0009, 0x000a, 0x000c, 0x000d, 0x0020}, code_point);
}
