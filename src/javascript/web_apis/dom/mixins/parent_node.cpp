...
dom::mixins::parent_node::parent_node()
{
    bind_get(children);
...
auto dom::mixins::parent_node::prepend(
        ...
        -> void
{
    ...
    ce_reaction_method_def
        auto* base = dynamic_cast<nodes::node*>(this);
...
auto dom::mixins::parent_node::append(
        same_as_any<nodes::node*, ext::string> auto&&... nodes)
        -> void
{
...
auto dom::mixins::parent_node::replace_children(
        same_as_any<nodes::node*, ext::string> auto&&... nodes)
        -> void
{
...
auto dom::mixins::parent_node::get_children() const -> ranges::ref_view<ext::vector<nodes::element*>>
{
    const auto* base = dynamic_cast<const nodes::node*>(this);
    const auto element_children = *base->child_nodes()
            | ranges::views::transform([](nodes::node* child_node) {return dynamic_cast<nodes::element*>(child_node);})
            | ranges::views::remove(nullptr);

    return elment_children;
}


auto dom::mixins::parent_node::to_v8(
        v8::Isolate* isolate) const &&
        -> ext::any
{
    return v8pp::class_<parent_node>{isolate}
            .inherit<web_apis::dom_object>()
            .function("prepend", &parent_node::prepend, v8::DontEnum)
            .function("append", &parent_node::append, v8::DontEnum)
            .function("replaceChildren", &parent_node::replace_children, v8::DontEnum)
            .auto_wrap_objects();
