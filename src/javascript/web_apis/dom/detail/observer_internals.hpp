...
auto dom::detail::observer_internals::queue_microtask(
        steps_t&& steps, v8::Isolate* event_loop, nodes::document* document) -> void
{
    JS_BLOCK_ENTER
...
auto dom::detail::observer_internals::queue_mutation_record(
        mutation_type_t type, nodes::node* target, ext::string_view name, ext::string_view namespace_,
        ext::string_view old_value, ext::vector<nodes::node*>& added_nodes, ext::vector<nodes::node*>& removed_nodes,
        nodes::node* previous_sibling, nodes::node* next_sibling) -> void
{
...
auto dom::detail::observer_internals::queue_tree_mutation_record(
        nodes::node* target, ext::vector<nodes::node*>& added_nodes, ext::vector<nodes::node*>& removed_nodes,
        nodes::node* previous_sibling, nodes::node* next_sibling) -> void
{
...
auto dom::detail::observer_internals::queue_task(
        v8::Task& task_source, steps_t&& steps, v8::Isolate* event_loop, nodes::document* document) -> void
{
    JS_BLOCK_ENTER
        JS_REALM_GET_IMPLIED
        event_loop = event_loop ? event_loop : implied_agent;
...
auto dom::detail::observer_internals::queue_global_task(
        v8::Task& task_source, v8::Local<v8::Object> global_object, steps_t&& steps) -> void
{
...
auto dom::detail::observer_internals::queue_element_task(
        v8::Task& task_source, html::elements::html_element* element, steps_t&& steps) -> void
{
