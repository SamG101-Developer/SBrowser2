...
{
public js_methods:
    auto create_document_type(ext::string_view qualified_name, ext::string_view public_id, ext::string_view system_id) const -> nodes::document_type;
    auto create_document(ext::string_view namespace_, ext::string_view qualified_name, nodes::document_type* document_type = nullptr) const -> nodes::xml_document;
    auto create_html_document(ext::string_view title = "") const -> nodes::document*;
