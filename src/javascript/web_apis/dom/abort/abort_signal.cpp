        ...
        -> abort_signal
{
    ...
    abort_signal signal;
    auto global = javascript::environment::realms::realm::relevant_realm(&signal).global_object<>();
    auto callback = [] {html::detail::queueing_internals::queue_global_task();};
    html::detail::timers::run_steps_after_timeout(global, "AbortSignal-timeout", milliseconds, callback);
