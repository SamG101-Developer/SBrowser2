...
public js_methods:
    ...
    auto get(ext::string_view instrument_key) -> ext::promise<ext::any>;
    auto keys() -> ext::vector<ext::string>;
    auto has(ext::string_view instrument_key) -> ext::promise<ext::boolean>;
